...
public class QuizListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_quiz_list, container, false);

        q1 = (Button) root.findViewById(R.id.tk_quiz1);

        q1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), Take_quiz_Activity.class);
                startActivity(i);
            }
        });

        String Speak = "You have 3 quizzes scheduled ";
